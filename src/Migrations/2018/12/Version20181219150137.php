...
final class Version20181219150137 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fos_user ADD token_updated TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->addSql('COMMENT ON COLUMN fos_user.srp_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN fos_user.token_updated IS \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP token_updated');
    }
}
