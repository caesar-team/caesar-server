...
final class Version20190312102902 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE item_mask (id UUID NOT NULL, item_id UUID NOT NULL, recipient_id UUID NOT NULL, assembled_item_id UUID DEFAULT NULL, secret TEXT NOT NULL, access VARCHAR(255) CHECK(access IN ('read', 'write')) NOT NULL, last_updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))");
